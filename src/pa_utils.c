...
int populate_inputs_from_pulseaudio(GtkWidget * button)
{
    int ctr;
	...
	*/
    ...
    for (ctr = 0; ctr < 16; ctr++) {
		...
		gtk_combo_box_append_text(GTK_COMBO_BOX(button),pa_input_devicelist[ctr].name);
		/*
