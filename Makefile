...
pkgdatadir = $(datadir)/extace
pkglibdir = $(libdir)/extace
pkgincludedir = $(includedir)/extace
...
CLEANFILES =  *~ core* -rf .dep*

EXTRA_DIST = configure CREDITS VERSION extace.spec AUTHORS TODO
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
mkinstalldirs = $(SHELL) $(top_srcdir)/mkinstalldirs
CONFIG_HEADER = config.h
CONFIG_CLEAN_FILES =  extace.spec VERSION
DIST_COMMON =  README ./stamp-h.in AUTHORS COPYING ChangeLog INSTALL \
Makefile.am Makefile.in NEWS TODO VERSION.in acconfig.h aclocal.m4 \
config.guess config.h.in config.sub configure configure.in \
extace.spec.in install-sh ltmain.sh missing mkinstalldirs
...
extace.spec: $(top_builddir)/config.status extace.spec.in
